...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { evaluation_id: @grade.evaluation_id, grade: @grade.grade, student_id: @grade.student_id } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { evaluation_id: @grade.evaluation_id, grade: @grade.grade, student_id: @grade.student_id } }
